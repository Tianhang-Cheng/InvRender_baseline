...
class MaterialTrainRunner():
    def __init__(self,**kwargs):
        ...
        self.test_dataset = utils.get_class(self.conf.get_string('train.dataset_class'))(
    ...
    def evaluate(self):
        ...
        print('evaluation number =', len(self.test_dataloader)) 
        
        for i, (indices, model_input, ground_truth) in enumerate(self.test_dataloader):

            # relight (only relight4synthetic and our_dataset has relight evaluation)
            if self.is_eval_relight:
                # synthetic4relight dataset
                # if i == 0:
                #     self.model.envmap_material_network.load_light('envmaps/envmap3')
                #     print('load light 1')
                # elif i == 13:
                #     self.model.envmap_material_network.load_light('envmaps/envmap6')
                #     print('load light 2')
                # elif i == 26:
                #     self.model.envmap_material_network.load_light('envmaps/envmap12')
                #     print('load light 3')
            ...
            model_outputs = utils.merge_output(res, self.total_pixels, batch_size=1) 
